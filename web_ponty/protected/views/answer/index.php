...
<h1><?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/answer_48.png', ''); ?> Answers  <div class="pull-right"><?php echo CHtml::link('<button class="btn btn-large" type="button">'.CHtml::image(Yii::app()->request->baseUrl . '/images/add_32.png').' &nbsp;&nbsp;New Answer</button>', array('answer/addAnswer', 'questionId' => $question->id)) ?></div> </h1>
<hr>
<br>
