...
<h1><?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/stack_48.png', ''); ?>
    Stacks  <div class="pull-right">
        <?php echo CHtml::link('<button class="btn btn-large" type="button">' . CHtml::image(Yii::app()->request->baseUrl . '/images/import_32.png') . ' &nbsp;&nbsp;Import Stack</button>', array('stack/importStack')) ?>
        <?php echo CHtml::link('<button class="btn btn-large" type="button">' . CHtml::image(Yii::app()->request->baseUrl . '/images/add_32.png') . ' &nbsp;&nbsp;New Stack</button>', array('stack/newStack')) ?></div> </h1>
<hr>
<br>
        ...
        <div class="pull-right">
            <div class="btn-toolbar" style="margin: 10px">
                <div class="btn-group">
                    ...
                    <?php
                    echo CHtml::link(
                            '<button class="btn">' . CHtml::image(Yii::app()->request->baseUrl . '/images/add_16.png') . ' Add Question</button>', array('question/addQuestion', 'stackId' => $stack->id))
                    ?>
                    <?php
                    echo CHtml::link(
                            '<button class="btn">' . CHtml::image(Yii::app()->request->baseUrl . '/images/edit_16.png') . ' Edit Stack</button>', array('stack/editStack', 'id' => $stack->id))
                    ?>
                    <?php
                    echo CHtml::link(
                            '<button class="btn">' . CHtml::image(Yii::app()->request->baseUrl . '/images/delete_16.png') . ' Delete Stack</button>', array('stack/deleteStack', 'id' => $stack->id), array('confirm' => 'Would you like to perforam removing "' . $stack->name . '"?' . "\n" . 'Please keep in mind that all questions and answers will be also delted!'))
                    ?>
                    );
