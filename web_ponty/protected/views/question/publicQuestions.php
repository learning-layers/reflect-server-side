...
<h1><?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/publicquestion_48.png', ''); ?> Public Questions </h1>
...
<div class="well well-large" style="padding-top: 0px; padding-left: 0px ; padding-right: 0px; margin-bottom: 50px">
    <div class="alert alert-info" style="margin: 0px; margin-bottom: 10px">
        <b><a  rel="tooltip" data-container="body" data-placement="right" title="<?php echo $tablename ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/question_16.png', ''); ?><?php echo ' ' . $tablename ?></a></b>
    </div>
