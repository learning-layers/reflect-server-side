...
<h1><?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/question_48.png', ''); ?> Add question
<div class="pull-right"><?php echo CHtml::link('<button class="btn btn-large" type="button">'.CHtml::image(Yii::app()->request->baseUrl . '/images/publicquestion_48.png', '').' &nbsp;&nbsp;Public Questions</button>', array('question/publicQuestions')) ?></div> </h1>
</h1>
